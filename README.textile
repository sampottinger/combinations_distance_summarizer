...
Example:
@python summarizer.py ./example/word_list_1.txt ./example/HowellNounDistances.csv y@
...
Example:
@bash many_input_files.bash ./example/word_lists.txt ./example/HowellNounDistances.csv ./example/results.txt@
